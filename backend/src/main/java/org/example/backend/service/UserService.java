...
/**
 * Domain service for {@link User} logic (CRUD + registration).
 *
 * <p>Responsibilities:
 * <ul>
 *   <li>Normalize usernames/emails (trim + lowercase) for consistent storage and lookup</li>
 *   <li>Hash passwords before persistence</li>
 *   <li>Use HTTP-friendly exceptions for not-found and conflicts</li>
 * </ul>
 */
@Service
public class UserService {
    ...
    /** Return a user by id or {@code null} if not found (controllers decide 404). */
    ...
    /**
     * Save a user, hashing the password and normalizing username/email.
     *
     * <p>Intended for creating new users (register flow).
     */
    ...
    /**
     * Register a new user; throws 409 on duplicate username/email.
     *
     * <p>Inputs are normalized before checks and storage.
     */
    ...
    /**
     * Update username/email/password with normalization and conflict checks.
     *
     * <p>Throws 404 if user missing, 409 if username/email conflict.
     */
