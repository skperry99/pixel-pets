...
/**
 * User domain logic (CRUD + registration).
 * - Normalizes usernames/emails (trim + lowercase) for consistent storage and lookup
 * - Uses HTTP-friendly exceptions for not-found and conflicts
 */
@Service
public class UserService {
     ...
     * Intended for creating new users (register flow).
     */
     ...
     * Inputs are normalized before checks and storage.
     */
     ...
     * Throws 404 if user missing, 409 if username/email conflict.
     */
