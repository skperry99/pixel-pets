...
/**
 * Pet entity.
 * - Maps DB column "hunger" to the domain field "fullness" (higher = better).
 * - Tracks lastTickAt for time-based stat decay.
 * - Uses safe defaults on create so new pets are always playable.
 */
@Getter
@Setter
@Entity
