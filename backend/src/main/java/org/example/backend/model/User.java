...
/**
 * User entity.
 * - Uses a dedicated "users" table (avoids reserved keyword conflicts)
 * - Enforces unique username/email at the DB level
 * - Owns a 1:N relationship to Pet (with cascade + orphan removal)
 */
@Getter
@Setter
@Entity
...
public class User {
     ...
     * Stored as "user_name" to avoid clashes and for readability.
     */
     ...
     * Cascade ALL lets us create/update pets via the user.
