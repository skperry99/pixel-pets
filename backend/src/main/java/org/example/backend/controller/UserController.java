...
/**
 * REST controller for basic User CRUD.
 * Routes under /api/users; CORS allowed from the Vite dev server.
 */
@RestController
...
public class UserController {
    ...
    /**
     * POST /api/users
     * Creates a new user from a DTO. Returns 201 Created with the saved DTO.
     */
    @PostMapping
    ...
    /**
     * PUT /api/users/{id}
     * Updates username/email/password. Returns the updated DTO.
     */
    @PutMapping("/{id}")
